...
data class Items(
    @PrimaryKey(autoGenerate = true) var srNo : Int? = null,
    ...
    @SerializedName("topics") var topics: ArrayList<String>? = null,
...
class OwnerTypeConverter {
    @TypeConverter
    fun fromString(string: String): Owner {
...
class TopicsTypeConverter {
    ...
    @TypeConverter
    fun fromList(array: ArrayList<String>): String {
